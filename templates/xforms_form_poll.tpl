    ...
    <form name="<{$form_output.name}>" id="<{$form_output.name}>" action="<{$form_output.action}>"
        ...
        <table class="outer bspacing1">
            <{foreach item=element from=$form_output.elements}>
                ...
                <tr>
                    <td class="width33"><{if '' == $element.caption}>&nbsp;<{/if}><{if 1 == $element.required}><{$form_req_prefix}><{/if}>
                        <{$element.caption}>
                ...
                <{ else}>
                <tr>
                    <td colspan="2"><{if '' == $element.caption}>&nbsp;<{/if}><{if 1 == $element.required}><{$form_req_prefix}><{/if}>
                        <{$element.caption}>
                        <{ if 1 == $element.required}><{$form_req_suffix}><{/if}>
                    </td>
                </tr>
                ...
                <tr>
                    <td colspan="2" class="center pad5 bold"><{$element.body}></td>
                </tr>
                <{    /if}>
            <{/foreach}>
        </table>
