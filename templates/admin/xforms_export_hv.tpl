...
<body>
<div style='margin-left: auto; margin-right: auto;'><h1
            class='center;'><{$smarty.const._AM_XFORMS_REPORT_FORM}>: <{$form_title}></h1></div>
<div style='margin-left: auto; margin-right: auto;'>
    <table style='border-spacing: 1px; margin: 0 auto;'>
        ...
        <{foreach item=element from=$elements}>
            ...
            <tr>
                <td style='background: #<{$bgitem}>;<{if !empty($element.border)}> <{$element.border}><{/if}> text-align: center;'
                    nowrap><{$element.ucount}></td>
                <td style='background: #<{$bgitem}>;<{if !empty($element.border)}> <{$element.border}><{/if}>'
                    nowrap><{$element.uname}></td>
                <td style='background: #<{$bgitem}>;<{if !empty($element.border)}> <{$element.border}><{/if}>'
                    nowrap><{$element.datet}></td>
