<div class="xform_block_form">
    ...
    <form name="<{$block.$form_output.name}>" id="<{$block.form_output.name}>" action="<{$block.form_output.action}>"
          method="<{$block.form_output.method}>" class="xforms" <{$block.form_output.extra}>>
        ...
        <{ /foreach}>
        <{ if '' != $block.form_text_global}>
        <div><{$block.form_text_global}></div><{/if}>
    </form>
</div>
