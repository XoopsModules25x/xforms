<div id="xforms">
    ...
    <{if $form_intro != ""}><p style="text-align: center;"><{$form_intro}></p><br/><{/if}>
                ...
                <{if $element.ele_type != "html"}>
                    <{if $element.hidden != true}>
                        <{if $element.display_row == 1}>
                            <tr>
                                <td width="35%"><{if $element.caption == "" }>&nbsp;<{/if}><{if $element.required == 1}><{$form_req_prefix}><{/if}>
                                    <{$element.caption}>
                                    <{if $element.required == 1}><{$form_req_suffix}><{/if}>
                                </td>
                                <td width="65%"><{$element.body}></td>
                            </tr>
                        <{else}>
                            <tr>
                                <td colspan="2"><{if $element.caption == "" }>&nbsp;<{/if}><{if $element.required == 1}><{$form_req_prefix}><{/if}>
                                    <{$element.caption}>
                                    <{if $element.required == 1}><{$form_req_suffix}><{/if}>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2"><{$element.body}></td>
                            </tr>
                        <{/if}>
                    <{/if}>
                <{else}>
                    ...
                    <tr>
                        <td colspan="2" style="text-align: center; padding: 5px; font-weight: bold;"><{$element.body}></td>
                    </tr>
                <{/if}>
            <{/foreach}>
        </table>
