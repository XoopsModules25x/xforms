 ...
 * @return bool
 */
function xoops_module_update_xforms($module, $prev_version)
{
    ob_start();
    //    invert_nohtm_dohtml_values();

    //    if ($prev_version <= 121)
    update_tables_to_130($module);
...
zz
    ...
    $downloadHandler = xoops_getModuleHandler('download', 'xforms');
    ...
    $moduleHandler = xoops_getModuleHandler('modification', 'xforms');
    ...
    $brokenHandler = xoops_getModuleHandler('report', 'xforms');
