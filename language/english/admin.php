...
define('_AM_XFORMS_ELE_CHECKBOX', 'Check boxes');
...
define('_AM_XFORMS_ELE_OBFUSCATED', 'Obfuscated Input');
...
define('_AM_XFORMS_SEND_COPY_DESC',
       'Indicate whether to send copy of form to the user. It will be sent to their personal email if the user is registered. If not registered, you must add an element in the form to request email.');
...
//2.00
define('_AM_FORMS_CONTACT_INFO', 'Contact Information');
define('_AM_XFORMS_ELE_DATE', 'Date Selection');
define('_AM_XFORMS_ELE_COUNTRY', 'Country Selection');
define('_AM_XFORMS_RUSUREEFORMS', 'Are you sure you want to import forms/elements from %s?');
...
//define('_AM_XFORMS_USERDATA_FAILED', "There was an error updating user data for the '%s' form.");
//define('_AM_XFORMS_ELEMENT_FAILED', "Failed to create the '%s' element in the database. %s");
//define('_AM_XFORMS_ELEMENT_IMPORT_FAILED', "The '%s' element was not imported. %s");
