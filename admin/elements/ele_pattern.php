...
$ptnInput = new XformsFormInput(_AM_XFORMS_ELE_PATTERN_INP, 'ele_value[3]', 25, 50, $pattern, null, 'text');
$ptnInput->setDescription(_AM_XFORMS_ELE_PATTERN_INP_DESC);

$ptnDesc = new XformsFormInput(_AM_XFORMS_ELE_PATTERN_DESC, 'ele_value[4]', 25, 50, $pattern, null, 'text');
