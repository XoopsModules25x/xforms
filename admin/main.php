        ...
        if ($forms) {
            ...
            foreach ($forms as $f) {
                if ($showAll || $f->isActive()) {
                    ...
                    if (XformsConstants::SEND_TO_OTHER == $sendTo) {
                    ...
                    if (!$f->isActive()) {
                        if (XformsConstants::FORM_INACTIVE == $f->getVar('form_active')) {
                            ...
                            $fAction = " <a href='" . $_SERVER['PHP_SELF'] . "?op=active&form_id={$id}'><img src='{$mypathIcon16}/active.gif' class='tooltip floatcenter1' title='" . _AM_XFORMS_ACTION_ACTIVE . "' alt='" . _AM_XFORMS_ACTION_ACTIVE . "'></a>";
                        } else {
                        ...
                        $fAction = "<a href='" . $_SERVER['PHP_SELF'] . "?op=inactive&form_id={$id}'><img src='{$mypathIcon16}/inactive.gif' class='tooltip floatcenter1' title='" . _AM_XFORMS_ACTION_INACTIVE . "' alt='" . _AM_XFORMS_ACTION_INACTIVE . "'></a>";
                    }
            ...
            if ($totalList > 0) {
                ...
                echo "<fieldset><legend class='bold' style='color: #900;'>"
                     ...
                     . "<div class='pad7'>\n"
                     . "  <div class='center'>\n"
                     . "    <img src='{$mypathIcon16}/active.gif' style='margin-right: .5em;'><span style='padding-right: 3em;'>"
                     . _AM_XFORMS_STATUS_ACTIVE
                     . '</span>'
                     . "    <img src='{$mypathIcon16}/inactive.gif' style='margin-right: .5em;'><span style='padding-right: 3em;'>"
                     . _AM_XFORMS_STATUS_INACTIVE
                     . '</span>'
                     . "    <img src='{$mypathIcon16}/expired.gif' style='margin-right: .5em;'>"
    ...
    case 'saveform':
        ...
        if (!empty($error)) {
            ...
            if (_AM_XFORMS_SAVE_THEN_ELEMENTS == $_POST['submit']) {
                redirect_header($helper->url("admin/elements.php?form_id={$ret}"), XformsConstants::REDIRECT_DELAY_NONE, _AM_XFORMS_DBUPDATED);
            } else {
                redirect_header($_SERVER['PHP_SELF'], XformsConstants::REDIRECT_DELAY_NONE, _AM_XFORMS_DBUPDATED);
            }
        }
