...
//                $hidden_id = new \XoopsFormHidden('ele_id[]', $id);
                ...
                echo '  <tr>'
                   . '    <td class="odd">' . $myts->displayTarea($eleObj->getVar('ele_caption'), Constants::ALLOW_HTML) . '</td>'
                   ...
                   . '      <a href="' . $helper->url('admin/editelement.php?op=edit&amp;ele_id=' . $id . '&amp;form_id=' . $formId) . '">'
                   .    '<img src="' . Admin::iconUrl('edit.png', '16') . '" class="tooltip floatcenter1" title="' . _EDIT . '"></a>'
                   . '      <a href="' . $helper->url('admin/editelement.php?op=edit&amp;ele_id=' . $id . '&amp;form_id=' . $formId . '&amp;clone=1') . '">'
                   .    '<img src="' . Admin::iconUrl('editcopy.png', '16') . '" class="tooltip floatcenter1" title="' . _CLONE . '"></a>'
                   . '      <a href="' . $helper->url('admin/editelement.php?op=delete&amp;ele_id=' . $id . '&amp;form_id=' . $formId) . '">'
